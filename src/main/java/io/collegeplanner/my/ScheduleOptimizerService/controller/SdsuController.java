...
import io.collegeplanner.my.ScheduleOptimizerService.shared.sdsu.SdsuScraper;
...
public class SdsuController extends GeneralServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        super.setScraper(new SdsuScraper());
