...
<footer>
<!-- Modal -->
<div id="tableModal" class="modal fade" role="dialog" aria-labelledby="tableModalLabel" aria-hidden="true" data-dismiss="modal">
    <div class="modal-header" data-dismiss="modal">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 data-dismiss="modal">Course Information</h3>
    </div>
    <div id="courseDetails" class="modal-body" data-dismiss="modal"></div>
