$(document).ready(function(){
    ...
    -----------------------------------------------------------*/
    (function(){
        $('body').on('click', '.tile .tile-info-toggle', function(e){
            e.preventDefault();
    ...
    -----------------------------------------------------------*/
    (function(){
        $('body').on('click', '.drawer-toggle', function(e){
            e.preventDefault();
    ...
    -----------------------------------------------------------*/
    $(function() {
        $('body').on('click', '.chat-list-toggle', function(){
            $(this).closest('.chat').find('.chat-list').toggleClass('toggled');
        });

        $('body').on('click', '.chat .chat-header .btn', function(e){
            e.preventDefault();
    ...
    (function(){
        ...
        $('body').on('click', '.tab-vertical li', function(){
    ...
    -----------------------------------------------------------*/
    (function(){
	$('body').on('click', '.box-switcher', function(e){
	    e.preventDefault();
...
-----------------------------------------------------------*/
$(function() {
        var scntDiv = $('#unavailability-form');
        var i = $('#unavailability-form p').size() / 3 + 1;
	
		
        $('#addScnt').on('click', function() {		
				$('<div class="row"><div class="col-xs-5 col-md-4 m-b-15"><p>I don\'t want classes from:</p><div class="input-icon datetime-pick time-only-12"><input data-format="hh:mm:ss" name="unavTime" type="text" placeholder="(Click the \'plus\' icon)" class="form-control input-sm" />' +
				  '<span class="add-on"><i class="sa-plus"></i></span></div></div><div class="col-xs-1"><p style="text-align:center;"><br><br>until</p></div><div class="col-xs-5 col-md-4 m-b-15"><p><br></p>' +
				  '<div class="input-icon datetime-pick time-only-12"><input data-format="hh:mm:ss" name="unavTime" type="text" placeholder="(Click the \'plus\' icon)" class="form-control input-sm"/><span class="add-on"><i class="sa-plus"></i></span>' +
				  '</div></div><div class="col-xs-1 col-md-3"></div></div><div class="row"><div class="col-xs-1"></div><div class="col-xs-11 "><label class="checkbox-inline"><input type="hidden" name="days" value="M"><input type="checkbox" name="days" value="TRUE"> Mon<label class="checkbox-inline">' +
				  '<input type="hidden" name="days" value="T"><input type="checkbox" name="days" value="TRUE"> Tues<label class="checkbox-inline"><input type="hidden" name="days" value="W"><input type="checkbox" name="days" value="TRUE"> Wed<label class="checkbox-inline"><input type="hidden" name="days" value="TH">\n\ ' +
                                  '<input type="checkbox" name="days" value="TRUE"> Thurs<label class="checkbox-inline"><input type="hidden" name="days" value="F">' +
				  '<input type="checkbox" name="days" value="TRUE"> Fri<label class="checkbox-inline"><input type="hidden" name="days" value="S"><input type="checkbox" name="days" value="TRUE"> Sat</div></div>)').appendTo(scntDiv);
				$('input').iCheck({
					checkboxClass: 'icheckbox_minimal',
					radioClass: 'iradio_minimal'
				});
